...
<head>
    ...
    <title>Offline — PAS - Portal Academy Sekolah</title>
...
<div class="badge"><i class="bi bi-exclamation-triangle"></i> Server tidak merespons</div>
</div>
<div class="body">
...
<div class="actions">
<button class="btn btn-primary" data-action="retry"><i class="bi bi-arrow-clockwise"></i> <span id="retryLabel">Coba Lagi</span></button>
