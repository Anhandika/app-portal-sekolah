...
<body>
<div class="topbar"><div class="logo" style="background:transparent;padding:2px;"><img src="{{ asset('logo_sekolah.png') }}" style="width:100%;height:100%;object-fit:contain;border-radius:8px;" alt="PAS"></div><div class="brand">PAS - Portal Academy Sekolah</div><div class="time" id="clock"></div></div>
<div class="wrap">
<div class="card">
<div class="hero">
