...
<div class="lms-body">
    ...
    @if($materi->file_materi)
        <div class="lms-card">
            ...
            <a href="{{ \App\Services\FirebaseStorageService::url($materi->file_materi) }}" onclick="puiExportFile(this.href,'{{ $materi->file_nama ?: 'Materi' }}','pdf'); return false;" class="lms-file">
