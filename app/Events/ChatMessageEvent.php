...
class ChatMessageEvent implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        ...
        return [
            ...
            'file_url' => $isDeleted ? null : ($this->message->file ? \App\Services\FirebaseStorageService::url($this->message->file) : null),
            'nama' => $sender?->name,
            'foto' => $sender?->foto ? \App\Services\FirebaseStorageService::url($sender->foto) : null,
